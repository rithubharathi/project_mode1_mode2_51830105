...
public class BankappSpringbootApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		EmployeeDetails emp1=new EmployeeDetails("rithu",5183,"manager",22,"rithu@gmail.com","9876543210","Bangalore");
		EmployeeDetails emp2=new EmployeeDetails("samyuktha",5185,"accountant",30,"samyuktha@gmail.com","7890654321","Chennai");
